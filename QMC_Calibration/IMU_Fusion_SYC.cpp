...
void IMU::begin(uint8_t choose){
  ...
  if(choose == CHOOSE_MPU6050 || choose == CHOOSE_ALL)
  {
    ...
    if(I2C_Read(MPU6050_ID, MPU6050_ADDR) != MPU6050_ADDR)
    {
      ...
      I2C_Write(MPU6050_INT_PIN_CFG, 0x02, MPU6050_ADDR);
      I2C_Write(MPU6050_USER_CTRL, 0x00, MPU6050_ADDR);
      delay(100);
      I2C_Write(MPU6050_GYRO_CONFIG, 0x08, MPU6050_ADDR);
    }
  }
...
void IMU::Calculate() {
  ...
  {
    int16_t raw_x_lsb, raw_x_msb, raw_y_lsb, raw_y_msb, raw_z_lsb, raw_z_msb;
    ...
    QMC_RawX = (int16_t)(raw_x_lsb | raw_x_msb << 8);
    QMC_RawY = (int16_t)(raw_y_lsb | raw_y_msb << 8);
    QMC_RawZ = (int16_t)(raw_z_lsb | raw_z_msb << 8);
    ...
    Serial.println("=======================================");
    Serial.println("IMU:Calculate");
    Serial.print("X_MSB: ");
    Serial.print(raw_x_msb);
    Serial.print("\t\tX_LSB: ");
    Serial.print(raw_x_lsb);
    Serial.print("\t\tRAW_X: ");
    Serial.println(QMC_RawX);

    Serial.print("Y_MSB: ");
    Serial.print(raw_y_msb);
    Serial.print("\t\tY_LSB: ");
    Serial.print(raw_y_lsb);
    Serial.print("\t\tRAW_Y: ");
    Serial.println(QMC_RawY);

    Serial.print("Z_MSB: ");
    Serial.print(raw_z_msb);
    Serial.print("\t\tZ_LSB: ");
    Serial.print(raw_z_lsb);
    Serial.print("\t\tRAW_Z: ");
    Serial.println(QMC_RawZ);
