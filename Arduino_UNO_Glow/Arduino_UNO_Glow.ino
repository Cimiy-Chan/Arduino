...
#define LED_PIN     9 //Origianl is LED_PIN 5
#define NUM_LEDS    50
#define BRIGHTNESS  5 //Brightness 5 is enough for debugging. Lesser LED power consumption.
#define LED_TYPE    WS2812B //Original is WS2811
